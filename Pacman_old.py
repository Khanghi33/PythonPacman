...
#     num1 = math.floor((HEIGHT - 50) * SCALE_FACTOR) // 32
#     num2 = math.floor(WIDTH * SCALE_FACTOR) // 30
#     if 0 < player_x < math.floor(870 * SCALE_FACTOR):
...
def draw_board():
    dI = X // 34
    dJ = X // 32
    num2 = math.floor((WIDTH // 30) * SCALE_FACTOR)
...
while run:
    ...
    player_circle = pygame.draw.circle(screen, 'black', (center_x, center_y), math.floor(20 * SCALE_FACTOR), math.floor(2 * SCALE_FACTOR))
    draw_player()
    ...
    if player_x > math.floor(900 * SCALE_FACTOR):
        player_x = math.floor(-47 * SCALE_FACTOR)
    elif player_x < math.floor(-50 * SCALE_FACTOR):
        player_x = math.floor(897 * SCALE_FACTOR)
